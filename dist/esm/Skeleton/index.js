...
export default function Skeleton(props) {
  ...
  if (loading) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: cls(styles.skeleton, className, (_cls = {}, _defineProperty(_cls, styles.xl, count === 1), _defineProperty(_cls, styles.lg, count === 2), _defineProperty(_cls, styles.md, count === 3), _defineProperty(_cls, styles.sm, count === 4), _defineProperty(_cls, styles.xs, count === 5), _cls))
